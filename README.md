...
Выделить 60 EVER на создание системных токенов для вестинга (по 5 EVER на каждый токен)

Выделить 60 EVER на создание пар системных токенов на tonswap.io для создания вестинга. 

Выделить 10 EVER на оплату комиссии транзакций.
